...
if(isset($_GET['delete'])){
   ...
   header('location:manage_contact_table.php');
};
...
<?php
   ...
   <div class="product-display">
      <table class="product-display-table" style="position:relative; left:25rem;">
         <thead>
         <tr>
            <th>Sr. No</th>
            <th>Full Name </th>
         ...
         <tr>
            ...
            <td>
               <a href="manage_contact_table.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
